...
url = [
"http://www.transfermarkt.co.uk/france-u21/leistungsdaten/verein/9323/plus/0?reldata=U21Q%262015",
"http://www.transfermarkt.co.uk/czech-republic-u21/leistungsdaten/verein/8771/plus/0?reldata=U21Q%262015",
"http://www.transfermarkt.co.uk/moldova-u21/leistungsdaten/verein/24955/plus/0?reldata=U21Q%262015",
"http://www.transfermarkt.co.uk/georgia-u21/leistungsdaten/verein/12148/plus/0?reldata=U21Q%262015",
"http://www.transfermarkt.co.uk/sweden-u21/leistungsdaten/verein/8595/plus/0?reldata=U21Q%262015"
]

national = [
"France U21","Czech Republic U21","Moldova U21","Georgia U21","Sweden U21"
]
...
for j in 3..(url.size-1)
  ...
  st = connection.prepare("insert into olympic (name,age,height,position,national,team,team_national,division,minutes) values (?,?,?,?,?,?,?,?,?) on duplicate key update team=?,team_national=?,division=?,minutes=?")
