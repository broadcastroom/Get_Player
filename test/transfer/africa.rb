...
national = [
"Uganda","Egypt","Nigeria","Morocco","Libya",
"Zambia","Algeria","Ivory Coast","Ghana","Tunisia",
"Senegal","Cape Verde","Cameroon","Congo","DR Congo",
"Mali","Gabon","South Africa","Guinea","Burkina Faso"
]

connection = Mysql::new("127.0.0.1", "root", "motokokusanagi", "soccer_player")

for j in 14..(url.size-1)
